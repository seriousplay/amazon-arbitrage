...
class TestMatchResult:
    def test_result_creation(self):
        ...
        alibaba = AlibabaProduct(item_id="1", title="T2", price=5.0, min_order_qty=10, matched_score=80.0)
        r = MatchResult(
            amazon=amazon,
            alibaba=alibaba,
            score=75.0,
    ...
    def test_confidence_high(self):
        ...
        alibaba = AlibabaProduct(item_id="1", title="T", price=1.0, min_order_qty=1, matched_score=90.0)
        r = MatchResult(
            amazon=amazon, alibaba=alibaba,
            score=90.0, price_diff_usd=80.0,
            estimated_profit_margin=80.0, total_cost_usd=20.0,
    ...
    def test_confidence_low(self):
        ...
        alibaba = AlibabaProduct(item_id="1", title="T", price=1.0, min_order_qty=1, matched_score=10.0)
        r = MatchResult(
            amazon=amazon, alibaba=alibaba,
            score=30.0, price_diff_usd=2.0,
            estimated_profit_margin=20.0, total_cost_usd=8.0,
