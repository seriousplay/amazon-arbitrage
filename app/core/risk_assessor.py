...
TRADEMARKED_BRANDS = {
    ...
    "nintendo", "playstation", "xbox", "apple", "samsung",
    "lego", "barbie", "hot wheels", "frozen", "paw patrol",
    "coco melon", "peppa pig", "spiderman", "batman", "superman",
    "hello kitty", "minions", "transformers", "nerf", "fisher price",
    "vtech", "leapfrog", "melissa doug", "crayola", "play doh",
    "bose", "sony", "jbl", "beats", "dyson", "irobot",
    "keurig", "nespresso", "kitchenaid", "instant pot",
    "swiffer", "febreze", "mr clean", "magic eraser",
    "yeti", "stanley", "hydro flask", "owala",
    "lululemon", "under armour", "the north face", "patagonia",
    "coach", "michael kors", "kate spade", "tory burch",
    "ray ban", "oakley", "warby parker",
    "ugg", "crocs", "birkenstock", "dr martens",
    "victoria secret", "calvin klein", "tommy hilfiger",
    "ralph lauren", "lacoste", "burberry",
}
